                            ...
                            <div className="flex flex-col md:flex-row w-full md:w-auto gap-3">
                                <div className="relative">
                                    <input
                                        ...
                                        className="border border-gray-300 rounded-md pl-3 pr-20 py-2 w-full md:w-80 focus:outline-none focus:ring-1 focus:ring-green-500"
                                        value={searchQuery}
                                        onChange={(e) =>
